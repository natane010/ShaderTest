Shader "Custom/NewCrearWaterWaveInfinity"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2g vert(appdata v)
            {
                ...
                // 座標変換
                o.vertex = mul(UNITY_MATRIX_VP, o.vertexWave);
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                //// ディフューズ
                //float3 toLightDirWave = normalize(_WorldSpaceLightPos0.xyz) * R;
                ...
                //float3 specularColor = pow(max(0.0, dot(reflect(-toLightDirWave, normalWave), vertexToCameraWave)), 5.0f);
