    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(g2f i) : SV_Target
            {
                ...
                float3 envColor = (max(0.0, diffusePower * R) * _Color.rgb * col.xyz);
                float3 diffuseColor = (srcColor + diffusePower) * envColor;
                ...
                col.rgb += diffuseColor * 0.5 * (specularColor * 0.75f);
